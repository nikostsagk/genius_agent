...
public class ExampleAgent extends AbstractNegotiationParty {
    ...
    private Bid myLastOffer, myWorstOffer;
    ...
    private boolean worstStuff = true;
	...
	public Action chooseAction(List<Class<? extends Action>> list) {
	    ...
	    if (lastReceivedOffer != null
		                && myLastOffer != null
		&& this.getUtility(lastReceivedOffer) > this.getUtility(myWorstOffer)) {
		...
		if(worstStuff) {
		    myWorstOffer = myLastOffer;
		    worstStuff = false;
		}
		if(this.getUtility(myWorstOffer) >= this.getUtility(myLastOffer)) {
		    myWorstOffer = myLastOffer;
		    System.out.println("WORST OFFER UTILITY");
		    System.out.println(this.getUtility(myWorstOffer));
		}
		System.out.println("Sending following offer");
